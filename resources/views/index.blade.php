    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="http://internet-shop.tmweb.ru/person/orders">Мои заказы</a></li>
                <li><a href="http://internet-shop.tmweb.ru/logout">Выйти</a></li>
            </ul>
        </div>
    </div>
</nav>
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <form action="http://internet-shop.tmweb.ru/basket/add/4" method="POST">
                            Не доступен                                <a href="http://internet-shop.tmweb.ru/mobiles/iphone_5se"
                                                                          class="btn btn-default"
                                                                          role="button">Подробнее</a>
                            <input type="hidden" name="_token" value="ucSgRQSB8Ud6hHyfrPh15axtgW2XnpXiMJGsKpMY">            </form>
                        </p>
